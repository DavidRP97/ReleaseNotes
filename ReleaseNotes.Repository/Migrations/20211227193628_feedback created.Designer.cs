...
namespace ReleaseNotes.Repository.Migrations
{
    ...
    [Migration("20211227193628_feedback created")]
    partial class feedbackcreated
    {
            ...
            modelBuilder.Entity("ReleaseNotes.Entities.Model.Feedback.ReleasesFeedback", b =>
                {
                    ...
                    b.HasOne("ReleaseNotes.Entities.Model.ReleasesPowerServer.Module", "ModulePowerServer")
                        .WithMany("Feedbacks")
